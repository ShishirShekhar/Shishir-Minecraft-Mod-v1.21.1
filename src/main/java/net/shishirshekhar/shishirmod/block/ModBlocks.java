...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> SHISHIRMITE_ORE = registerBlock("shishirmite_ore",
            () -> new DropExperienceBlock(UniformInt.of(2, 4),
                    BlockBehaviour.Properties.of().strength(4f).requiresCorrectToolForDrops()));

    public static final RegistryObject<Block> SHISHIRMITE_DEEPSLATE_ORE = registerBlock("shishirmite_deepslate_ore",
